...
Shader "Custom/GaussianBlur_CamTransition"
{
	...
	SubShader
	{
		...
		Pass
		{
            ...
            uniform sampler2D _Blur01;
			uniform sampler2D _Blur02;
			...
			float4 frag(v2f i) : SV_Target
			{
                ...
                blurColor = lerp(tex2D(_Blur01,buv),tex2D(_Blur02,buv),_BlurTransition);
				//blurColor = tex2D(_Blur02,buv);
